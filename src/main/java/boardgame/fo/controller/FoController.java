...
public class FoController {
    ...
    public ModelAndView selectPlayRcrdByAllList(CommandMap commandMap, HttpServletRequest request) throws Exception {
        ModelAndView mv = new ModelAndView("jsonView");
        Boolean result = false;
        String resultMsg = "";

        mv.addObject("map", foService.selectPlayRcrdByAllList(commandMap.getMap()));
        result = true;
    ...
    public ModelAndView selecPlayRcrdByClubList(CommandMap commandMap, HttpServletRequest request) throws Exception {
        ...
        mv.addObject("map", foService.selectPlayRcrdByClubList(commandMap.getMap()));
        result = true;
    ...
    public ModelAndView selecPlayRcrdByMmbrList(CommandMap commandMap, HttpServletRequest request) throws Exception {
        ...
        mv.addObject("map", foService.selectPlayRcrdByMmbrList(commandMap.getMap()));
        result = true;
    ...
    public ModelAndView selecPlayRcrdByGameList(CommandMap commandMap, HttpServletRequest request) throws Exception {
        ...
        mv.addObject("map", foService.selectPlayRcrdByGameList(commandMap.getMap()));
        result = true;
    ...
    public ModelAndView selectBocPlayRcrdList(CommandMap commandMap, HttpServletRequest request) throws Exception {
        ModelAndView mv = new ModelAndView("jsonView");
        Boolean result = false;
        String resultMsg = "";

        mv.addObject("map", foService.selectBocPlayRcrdList(commandMap.getMap()));
        result = true;
