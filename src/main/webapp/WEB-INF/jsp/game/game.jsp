        ...
        <div class="row">
            <div class="col-xl-12 mb-5 mb-xl-0">
                <div class="card shadow mt-5">
                    ...
                    <div class="card-body">
                        <div name="buttonDiv">
                            <button type="button" class="btn btn-default" onclick="openBocTroubleBrewing()">
                                B.O.C. - trouble brewing
                            </button>
                            <button type="button" class="btn btn-default" onclick="openFruitShop()">
                                과일가게
                            </button>
                        </div>
                    </div>
