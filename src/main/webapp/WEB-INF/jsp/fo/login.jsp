								...
								<div class="form-group mb-3">
									<div class="input-group input-group-alternative">
										...
										<input class="form-control hasValue emailOnly" placeholder="이메일" type="email"
											id="email" name="email" onKeypress="gfn_hitEnter(event, 'fn_doLogin()');"/>
									</div>
								</div>
								<div class="form-group">
									<div class="input-group input-group-alternative">
										...
										<input class="form-control hasValue pswrdOnly" placeholder="비밀번호" type="password"
											 id="pswrd" name="pswrd" onKeypress="gfn_hitEnter(event, 'fn_doLogin()');"/>
									</div>
								</div>
								<div class="text-center">
									<button type="button" class="btn btn-primary btn-block" onclick="fn_doLogin();">로그인</button>
								</div>
							</form>
						</div>
					</div>
