	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
						...
						<div class="row clearfix">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<textarea rows="4" name="fdbck" class="form-control form-control-alternative hasValue"></textarea>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
									<label class="form-control-label">플레이사진</label>
									<input type="file" data-name="플레이사진" name="file" class="form-control form-control-alternative">
								</div>
							</div>
						</div>
					</form>
			...
			<div class="modal-footer">
				<button type="button" id="updatePlayMmbrFdbckBtn" class="btn btn-primary display-none" onclick="fn_updatePlayMmbrFdbck();">소감 남기기</button>
