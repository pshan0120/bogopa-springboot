...
<head>
    ...
    <script>
        ...
        const openMemberProfileImageModal = () => {
            const memberId = "<c:out value="${mmbrNo}" />";
            const memberProfileImageUrl = $("#prflImg").attr("src");
            memberProfileImageModal.open(memberId, memberProfileImageUrl);
        };
    ...
    <div class="container mt--7">
        <div class="row">
                ...
                <div class="card card-profile shadow">
                    <div class="card-header">
                        <div class="row clearfix">
                            <div class="col-lg-12">
                                <button type="button" class="btn btn-sm btn-info" onclick="fn_openQckSrvcGuide();">퀵서비스
                                    안내
                                </button>
                                <button type="button" class="btn btn-sm btn-primary float-right"
                                        onclick="fn_updateMmbr();">정보수정
                                </button>
                                <!--
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <a href="javascrit:void(0);" onclick="openMemberProfileImageModal();">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" data-name="내 소개" name="intrdctn" id="intrdctn"
                                                  class="form-control form-control-alternative hasValue"
                                                  placeholder="다른 회원들을 위해 간단한 자기 소개를 적어주세요."></textarea>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <div class="col-xl-8 order-xl-1">
                ...
                <%--<div class="card shadow display-none mt-5" id="myClubMmbrDiv">
                    <div class="card-header bg-white border-0">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <button type="button" class="btn btn-sm btn-primary float-right display-none"
                                        id="openMyClubBtn" onclick="fn_openMyClub();">내 모임관리
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <%--<div class="card shadow mt-5 display-none" id="myClubBoardDiv">
                    <div class="card-header bg-white border-0">
                        <div class="row">
                            <div class="col-6">
                ...
                <%--<div class="card shadow display-none mt-5" id="myClubAttndDiv">
                    ...
                    <div class="card-footer py-4">
                        <nav aria-label="">
                            <ul class="pagination pagination-sm justify-content-end mb-0"
                                id="attndNotCnfrmListPageNav"></ul>
                        </nav>
                    </div>
                </div>--%>
                ...
                <%--<div class="card shadow display-none mt-5" id="myClubFeeDiv">
                    <div class="card-header bg-white border-0">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <button type="button" class="btn btn-sm btn-info float-right display-none"
                                        id="openInsertMyClubFee2Btn" onclick="fn_openInsertMyClubFee2();">기간회비 납입
                                </button>
                            </div>
                        </div>
                    </div>
...
<!-- 기간회비 납입 Modal -->
<div class="modal fade" id="insertMyClubFee2Modal" role="dialog" aria-labelledby="insertMyClubFee2ModalLabel"
     aria-hidden="true">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="feeFromDate"
                                       class="form-control form-control-alternative hasValue">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="feeToDate"
                                       class="form-control form-control-alternative hasValue">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-7">
                            <div class="form-group">
                                ...
                                <input type="text" name="hostMmbrNm" class="form-control form-control-alternative"
                                       readonly>
                            </div>
                        </div>
                        <div class="col-lg-12">
...
<!-- 퀵서비스 안내 Modal -->
<div class="modal fade" id="qckSrvcGuideModal" role="dialog" aria-labelledby="qckSrvcGuideModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="pl-lg-4">
                    <div class="form-group focused">
                        ...
                        <textarea rows="18" id="qckUrlText" class="form-control form-control-alternative"
                                  readonly></textarea>
                    </div>
                </div>
...
<%@ include file="/WEB-INF/jsp/fo/jspf/memberProfileImageModal.jspf" %>
