...
<script>
	$(function() {
		fn_selectNtcBrdList(1);
		fn_selectFaqBrdList(1);
	});

	function fn_selectNtcBrdList(pageNo) {
		var comAjax = new ComAjax("ntcBrdForm");
		comAjax.setUrl("<c:url value='/selectBrdList' />");
		comAjax.setCallback("fn_selectNtcBrdListCallback");
		comAjax.addParam("pageIndex", pageNo);
		comAjax.addParam("pageRow", 5);
		comAjax.addParam("brdTypeCd", "1");
		comAjax.ajax();
	}

	function fn_selectNtcBrdListCallback(data) {
		var cnt = data.map.cnt;
		var body = $("#ntcBrdListTbl>tbody");
		body.empty();
		var str = "";
		if(cnt == 0) {
				...
				<div class="col-xl-12 mb-5 mb-xl-0">
					<div class="card shadow mt-5">
						<div class="nav-wrapper">
							<ul class="nav nav-pills nav-fill flex-column flex-md-row mx-3" role="tablist" id="tabList">
								<li class="nav-item px-1">
									<a class="nav-link active" id="guideTab1A" data-toggle="tab" href="#guideTab1" role="tab" aria-controls="guideTab1" aria-selected="true">
										서비스 소개
									</a>
								</li>
								<li class="nav-item px-1">
									<a class="nav-link" id="guideTab2A" data-toggle="tab" href="#guideTab2" role="tab" aria-controls="guideTab2" aria-selected="true">
										공지사항
									</a>
								</li>
								<li class="nav-item px-1">
									<a class="nav-link" id="guideTab3A" data-toggle="tab" href="#guideTab3" role="tab" aria-controls="guideTab3" aria-selected="false">
										자주 묻는 질문
									</a>
								</li>
								<li class="nav-item px-1">
									<a class="nav-link" id="guideTab4A" data-toggle="tab" href="#guideTab4" role="tab" aria-controls="guideTab4" aria-selected="false">
										각종 문의
									</a>
								</li>
							</ul>
						...
						<div class="tab-content">
							<!-- 소개 탭 컨텐츠 -->
							<div id="guideTab1" class="tab-pane fade show active" role="tabpanel" aria-labelledby="guideTab1A">
							...
							<div id="guideTab2" class="tab-pane fade" role="tabpanel" aria-labelledby="guideTab2A">
								...
								<div class="card-body">
									<form id="ntcBrdForm" onsubmit="return false;">
											...
											<div class="col-lg-6">
												<div class="form-group">
													...
													<input type="text" name="srchText" class="form-control form-control-alternative" 
														onKeypress="gfn_hitEnter(event, 'fn_selectNtcBrdList(1)');" placeholder="제목, 내용">
												</div>
											</div>
										</div>
									</form>
									<div class="table-responsive">
										<table class="table align-items-center table-flush" id="ntcBrdListTbl">
								...
								<div class="card-footer py-4">
									<nav aria-label="">
										<ul class="pagination pagination-sm justify-content-end mb-0" id="ntcBrdListPageNav"></ul>
									</nav>
								</div>
							</div>
							<!-- 자주 묻는 질문 탭 컨텐츠 -->
							<div id="guideTab3" class="tab-pane fade" role="tabpanel" aria-labelledby="guideTab3A">
										...
										<div class="row clearfix">
											<div class="col-lg-6">
												<div class="form-group">
													<label class="form-control-label">게시물찾기</label>
													<input type="text" name="srchText" class="form-control form-control-alternative" 
														onKeypress="gfn_hitEnter(event, 'fn_selectFaqBrdList(1)');" placeholder="제목, 내용">
												</div>
											</div>
										</div>
									</form>
								...
								<div class="card-footer py-4">
									<nav aria-label="">
										<ul class="pagination pagination-sm justify-content-end mb-0" id="faqBrdListPageNav"></ul>
									</nav>
								</div>
							</div>
							<!-- 문의 탭 컨텐츠 -->
						...
						<div class="row clearfix">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="text" name="brdTypeNm" class="form-control form-control-alternative" readonly>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
							...
							<div class="col-lg-12">
								<div class="form-group">
									...
									<textarea rows="16" name="cntnts" class="form-control form-control-alternative" readonly></textarea>
								</div>
							</div>
						</div>
					</form>
