...
<head>
    ...
    <script type="text/javascript"
            src="//dapi.kakao.com/v2/maps/sdk.js?appkey=878b101b53e96c7e3a35c4c80a8bf320&libraries=clusterer"></script>
                            ...
                            <div class="col-lg-6">
                                <c:if test="${mmbrTypeCd eq '1' and clubNo eq ''}">
                                    <button type="button" class="btn btn-sm btn-primary float-right"
                                            onclick="fn_openInsertClubModal();">모임만들기
                                    </button>
                                </c:if>
                            </div>
                        </div>
                                ...
                                <form id="clubForm" onsubmit="return false;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="srchText" class="form-control form-control-alternative"
                                               onKeypress="gfn_hitEnter(event, 'fn_selectClubList(1)');"
                                               placeholder="모임이름, 모임장이름, 주소">
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" data-name="모임이름" name="clubNm"
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" data-name="연락처" name="telNo"
                                       class="form-control form-control-alternative mpNoOnly">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="file" data-name="프로필이미지" name="file"
                                       class="form-control form-control-alternative">
                            </div>
                        </div>
                    </div>
