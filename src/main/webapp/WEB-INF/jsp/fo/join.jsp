                        ...
                        <form role="form" id="form">
                            <div class="form-group mb-3">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control hasValue emailOnly" name="email" data-name="이메일"
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative mb-3">
                                    ...
                                    <input class="form-control hasValue" name="nickNm" data-name="닉네임" placeholder="닉네임"
                                           type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control hasValue pswrdOnly" name="pswrd" data-name="비밀번호"
                            ...
                            <div id="showClubJoinDiv" class="display-none">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="form-control-label">[<c:out value='${clubMap.clubNm}'/>]
                                                소개</label>
                                            <textarea rows="4" name="intrdctn"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="4" name="joinAnswr"
                            ...
                            <div class="row my-4">
                                <div class="col-12">
                                    <div class="custom-control custom-control-alternative custom-checkbox">
                                        <input class="custom-control-input hasValue" data-name="이용약관 동의"
                                               id="customCheckRegister" type="checkbox">
                                        <label class="custom-control-label" for="customCheckRegister">
                                            <span class="text-muted"><a href="javascript:(void(0));"
                                                                        onclick="fn_openUseTrmsModal();">이용약관</a>에 동의합니다.</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
