...
<script>
	...
	function fn_selectMyClubCallback(data) {
		...
		if(data.map.prflImgFileNm != "") {
			$("#prflImg").attr("src", "http://203.245.28.115/img/club/" + data.map.clubNo + "/" + data.map.prflImgFileNm);
			$("#updatePrflImg").attr("src", "http://203.245.28.115/img/club/" + data.map.clubNo + "/" + data.map.prflImgFileNm);
		} else {
			$("#prflImg").attr("src", "http://203.245.28.115/img/club/default.png");
			$("#updatePrflImg").attr("src", "http://203.245.28.115/img/club/default.png");
		}
	...
	function fn_selectMyClubAttndList(pageNo) {
		var comAjax = new ComAjax("myClubAttndForm");
	...
	function fn_selectMyClubFeeList(pageNo) {
		var comAjax = new ComAjax("myClubFeeForm");
	...
	function fn_insertClubAttndAll() {
		if(confirm("전체 모임원 대상으로 출석확인을 요청하시겠습니까?")) {
			var comAjax = new ComAjax("clubAttndForm");
					...
					<div class="card card-profile shadow">
						<div class="card-header">
							<div class="row clearfix">
								<div class="col-lg-12">
									<button type="button" class="btn btn-sm btn-primary float-right" onclick="fn_updateClub();">정보수정</button>
								</div>
							</div>
						</div>
								...
								<div class="row clearfix">
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<textarea rows="4" data-name="가입질문" name="joinQstn" class="form-control form-control-alternative"></textarea>
										</div>
									</div>
				...
				<div class="col-xl-8 order-xl-1">
					...
					<div class="card shadow mt-5">
						...
						<div class="display-none" id="myClubJoinDiv">
							...
							<div class="card-footer py-4">
								<nav aria-label="">
									<ul class="pagination pagination-sm justify-content-end mb-0" id="myClubJoinListPageNav"></ul>
								</nav>
							</div>
						</div>
					</div>
					...
					<div class="card shadow mt-5">
						<div class="card-header bg-white border-0">
							<div class="row">
								...
								<div class="col-6">
									<button type="button" class="btn btn-sm btn-info float-right" onclick="fn_openClubGameModal();">
										모임게임 관리
									</button>
								</div>
							</div>
						...
						<div class="card-footer py-4">
							<nav aria-label="">
								<ul class="pagination pagination-sm justify-content-end mb-0" id="myClubGameListPageNav"></ul>
							</nav>
						</div>
					</div>
					...
					<div class="card shadow mt-5">
						<div class="card-header bg-white border-0">
							<div class="row">
								...
								<div class="col-6">
									<button type="button" class="btn btn-sm btn-info float-right" onclick="fn_openClubAttndModal();">
										출석체크관리
									</button>
								</div>
							</div>
									...
									<div class="row clearfix">
										<div class="col-sm-12 col-lg-3">
											<div class="form-group">
												...
												<input type="date" name="attndDate" class="form-control form-control-alternative onChange">
											</div>
										</div>
										<div class="col-sm-12 col-lg-3">
											<div class="form-group">
												<label class="form-control-label" for="nickNm">모임원 닉네임</label>
												<input type="text" name="nickNm" class="form-control form-control-alternative"
										...
										<div class="col-sm-12 col-lg-3">
											<div class="form-group">
												...
												<select class="form-control form-control-alternative onChange" name="attndYn">
						...
						<div class="card-footer py-4">
							<nav aria-label="">
								<ul class="pagination pagination-sm justify-content-end mb-0" id="myClubAttndListPageNav"></ul>
							</nav>
						</div>
					</div>
					...
					<div class="card shadow mt-5">
						...
						<div class="card-footer py-4">
							<nav aria-label="">
								<ul class="pagination pagination-sm justify-content-end mb-0" id="myClubFeeListPageNav"></ul>
							</nav>
						</div>
					</div>
